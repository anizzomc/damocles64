...
void qwordToStr(char *dst, qword value);

/**
 * Uses a static buffer of 65 chars, This is not thread safe, cuz
 * all calls use the same buffer.
 */
char* qwordToStr2(qword value);
